    ...
    <view>
        ...
        <view class="right-action text--w111-fff flex-col flex-y-center z-800"
            ...
            <view class="mt-50 flex-col flex-y-center" @tap="contentLike">
                <text class="iconfont fs-72 icon-ic_love_2" :class="{'like-heart': currentData.is_like}"></text>
                <text class="fs-22 pt-10 text-center">{{currentData.like_num > 0 ? currentData.like_num : '点赞'}}</text>
            </view>
            <!-- 3.评论 -->
            <view class="mt-36 flex-col flex-y-center" @tap="toggleReplyDrawer" v-if="replyStatus">
                <text class="iconfont icon-icon_comment fs-64"></text>
                <text class="fs-22 pt-16 text-center">{{currentData.comment_num > 0 ? currentData.comment_num : '评论'}}</text>
            </view>
            <!-- 3.分享 -->
			<!-- #ifdef H5 || APP-PLUS -->
			<view class="mt-36 flex-col flex-y-center" @tap="openShare">
			    <text class="iconfont icon-icon_transmit fs-66"></text>
			    <text class="fs-22 pt-10">分享</text>
			</view>
			<!-- #endif -->
            <!-- #ifdef MP-WEIXIN -->
            ...
            <view class="mt-36 flex-col flex-y-center relative" v-if="showMore">
                <text class="iconfont icon-ic_more fs-60" @tap="()=>{showBubble = !showBubble}"></text>
        ...
        <view class="fixed-desc w-full text--w111-fff" :class="{'hide-tab':showFooter,'full-tab':fullVideo}">
            <view class="box mb-32">
                <view class="w-560 lh-42rpx fs-28 fw-500" v-show="currentData.author">@{{currentData.author}}</view>
                ...
                <scroll-view scroll-x="true" class="white-nowrap vertical-middle w-584 mt-24" show-scrollbar="false"
                    ...
                    <view class="inline-block mr-30" v-for="(pro,k) in currentData.product">
