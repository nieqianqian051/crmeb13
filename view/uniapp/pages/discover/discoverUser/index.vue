			...
			<view class="w-full h-full content" :style="[cardStyle]">
				<view class="info">
					<view class="flex-between-center">
					 	<view class="flex-y-center">
							<view class="w-140 h-140 rd-50-p111- relative" :class="userInfo.vip_status ? 'svip-border' : 'white-border'">
					 		...
					 		<view class="pl-28 text--w111-fff">
					 			<view class="fs-32 fw-500 flex-y-center">
								<text>{{userInfo.author}}</text>
						...
						<view class="w-154 h-58 rd-30rpx flex-center fs-24 text--w111-fff border-white" 
						...
						<view v-else class="w-124 h-58 rd-30rpx flex-center fs-24 text--w111-fff border-white" 
							@tap="followChange">
							<text v-show="!userInfo.is_follow" class="iconfont icon-ic_increase fs-24"></text>
							<text>{{userInfo.is_follow ? '已关注' : '关注'}}</text>
						</view>
					 </view>
					 <view class="fs-26 text--w111-fff lh-40rpx mt-20">
