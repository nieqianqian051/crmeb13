	...
	export default {
		...
		onShareAppMessage() {
			...
			return {
				...
				path: `/pages/discover/${that.infoData.content_type == 1 ? 'discoverDetails' : 'discoverVideo'}/index?id=${that.infoData.id}&spid=${that.uid}&relation_id=${that.params.relation_id}`
			};
		},
		// #endif
