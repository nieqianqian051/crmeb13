...
class Create implements ListenerInterface
{
    ...
    public function handle($event): void
    {
        ...
        //写入订单记录表
        OrderStatusJob::dispatch(['create', $orderId, ['change_price' => $group['change_price'] ?? 0, 'total_price' => $group['priceData']['pay_price'] ?? $orderInfo['total_price'], 'pay_price' => $orderInfo['pay_price']]]);
        //下单记录
