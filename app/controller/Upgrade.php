...
class Upgrade
{
    ...
    public function handleComment()
    {
        ...
        $list = $communityCommentServices->search([])->select()->toArray();
        foreach ($list as $item) {
            $is_reply = $item['is_reply'] ? 0 : 1;
            $communityCommentServices->update($item['id'], ['is_reply' => $is_reply]);
        }
    }
    ...
    {
        $data['new_version'] = 'CRMEB-PRO v3.1.1';
        $data['new_code'] = 312;
        $data['update_sql'] = [
            [
                'code' => 312,
                ...
                'sql' => "ALTER TABLE `@table`  MODIFY delete_time int DEFAULT NULL COMMENT '删除时间戳'"
            ],
            [
                'code' => 312,
                'type' => -1,
            ...
            [
                ...
                'sql' => "ALTER TABLE `@table`  MODIFY `delete_time` TIMESTAMP NULL DEFAULT NULL COMMENT '删除时间'"
            ],
        ];
        return $data;
    }
