            ...
            switch ($prize['type']) {
                ...
                case 4:
                    ...
                    if ($openid) {//公众号用户
                        ...
                        $openid = $wechatServices->getWechatOpenid($uid, 'routine');
                        $type = Payment::MINI;
                    }
                    //app微信用户
                    if (!$openid) {
                        $openid = $wechatServices->getWechatOpenid($uid, 'app');
                        $type = Payment::APP;
                    }
                    if ($openid) {
                        ...
                        Payment::merchantPay($openid, $wechat_order_id, (string)$prize['num'], '抽奖中奖红包', $type);
                    }
                    break;
                case 5:
