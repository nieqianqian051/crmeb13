    ...
    public function useIntegral(bool $useIntegral, $userInfo, string $payPrice, array $other)
    {
        ...
        if ($userInfo && $userInfo['integral'] > 0) {
            ...
            if ($useIntegral && $payPrice && $usable > 0) {
                ...
                $SurplusIntegral = (int)bcsub((string)$usable, (string)$usedIntegral, 0);
...
//                //获取运费计算中的最大值
        ...
        return compact('storePostage', 'storeFreePostage', 'isStoreFreePostage', 'sumPrice', 'totalPrice', 'totalIntegral', 'costPrice', 'vipPrice', 'levelPrice', 'memberPrice', 'storePostageDiscount', 'cartInfo');
    }
