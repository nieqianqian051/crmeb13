...
//            sort($item['detail'], SORT_STRING);
     ...
     * @return array
     */
    public function getSkuArray(array $where, string $field = 'unique,bar_code,cost,price,integral,ot_price,stock,image as pic,weight,volume,brokerage,brokerage_two,quota,product_id,code,settle_price', string $key = 'suk')
    {
